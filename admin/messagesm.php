...
$MSG5_MOVEDATA="prepis datotek in nastavitev dovoljenj";
...
$MSG14_DDV_UNPACKED="Paket DDV je zdaj razpakiran.";
$MSG15_DDV_IS_NOT_UNPACKED="Najprej razpakirajte izbrani paket DDV";
$MSG16_FOLDER_NOT_FOUND="Napaka, mapa ne obstaja";
$MSG17_FILE_NOT_FOUND="Napaka, ni datoteke";
$MSG18_DDV_NOT_SELECTED="Paket DDV ni izbran.";
...
$MSG47_REDACTCOMPLETED="Anonimizacija je zaključena. Preverite pravilnost.";
$MSG48_NOTCONFIGURED="ni konfiguirano, preverite:";
...
$MSG54_APPENDDATAINFO="V mapi mora biti dodana datoteka, npr. listA.txt, s podatki o vsebini, ki jo naknadno dodajamo.";
$MSG_EXIT="izhod";
...
$MSG5_MOVEDATA="Copy files and set permissions";
...
$MSG14_DDV_UNPACKED="DDV package unpacked.";
$MSG15_DDV_IS_NOT_UNPACKED="Please, first unpack the selected DDV package";
$MSG16_FOLDER_NOT_FOUND="Error, folder not found";
$MSG17_FILE_NOT_FOUND="Error, file not found";
$MSG18_DDV_NOT_SELECTED="Please first select a DDV package.";
...
$MSG54_APPENDDATAINFO="In the folder additional file, e.g. listA.txt, is expected with information about content we are adding.";
$MSG_EXIT="exit";
