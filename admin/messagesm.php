...
$MSG0_CREATEDB="kreiraj podatkovno zbirko";
...
$MSG3_ENABLEACCESS="nastavi dostopne pravice za sheme, vzpostavljene iz paketa SIARD";
...
$MSG0_CREATEDB="Create database";
$MSG1_SELECTPKG="Select a package";
$MSG2_UNPACKDDV="Unpack selected package";
$MSGS_INSTALLSIARD="Deploy selected package (create schema and upload the data)";
$MSG3_ENABLEACCESS="Set viewer permission for the schemas from the SIARD package";
...
$MSG37_MOREACTIVE="removal of the viewer is skipped as there is another database still activated";
