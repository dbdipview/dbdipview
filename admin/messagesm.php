...
$MSG4_CREATEAPL="kreiraj prazno shemo";
$MSG5_MOVEDATA="prenos podatkov v shemo";
...
$MSG0_CREATEDB="Create database container";
...
$MSG4_CREATEAPL="Create empty schema";
$MSG5_MOVEDATA="Populate the schema tables with the data";
