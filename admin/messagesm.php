...
$MSGS_INSTALLSIARD="namesti vsebino paketa SIARD (vzpostavitev sheme, prenos podatkov)";
...
$MSGS_INSTALLSIARD="Deploy selected SIARD package (create schema and upload the data)";
